...
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '=w+1if4no=o&6!la#5j)3wsu%k@$)6bf+@3=i0h!5)h9h)$*s7')
...
BROKER_URL = 'amqp://guest:guest@localhost:5672//' if DEBUG else 'amqp://guest:guest@localhost:5672//'
...
EMAIL_SEND_USERNAME = 'zhangshaohui@kyee.com.cn'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
